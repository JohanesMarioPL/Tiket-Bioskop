...
<div class="w-full">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-6 lg:p-8 border-b border-slate-100">
            <h2 class="text-xl font-bold text-slate-800">Pembuatan Akun Pengguna</h2>
            <p class="text-sm text-slate-500 mt-1">Isi detail akun di bawah ini untuk menambahkan administrator baru atau mendaftarkan pelanggan secara manual.</p>
        </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 lg:p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('email') }}" 
                        required
                        placeholder="Contoh: jane@example.com"
                        class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#708090] focus:border-[#708090] transition-shadow shadow-sm"
                    >
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="password" class="block text-sm font-bold text-slate-700 mb-1.5">Kata Sandi <span class="text-red-500">*</span></label>
                    <input 
                        type="password" 
                        name="password" 
                        id="password" 
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-slate-100">
                <a href="{{ route('admin.users.index') }}" class="px-5 py-2.5 rounded-xl border border-slate-200 text-slate-700 font-semibold hover:bg-slate-50 transition-colors text-sm">
                    Batal
                </a>
